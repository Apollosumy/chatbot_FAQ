...
async def show_help(message: Message, state: FSMContext):
    await message.answer(
        ...
        "Ось що я можу:\n\n"
        "🔍 Задати питання\n"
        "Ви можете поставити будь-яке запитання, і я спробую знайти відповідь у базі знань.\n\n"
        "📄 Отримати інструкцію\n"
        "Відкрийте меню та перегляньте список доступних інструкцій у зручній структурі.\n\n"
        "🔎 Знайти інструкцію\n"
        "Якщо знаєте ключові слова, просто введіть їх, і я знайду потрібну інструкцію швидше.\n\n"
        "❗ Повідомити про помилку\n"
        "Якщо щось працює неправильно або відповідь була некоректною — надішліть мені відгук. Це допоможе зробити мене кращим."
    )
